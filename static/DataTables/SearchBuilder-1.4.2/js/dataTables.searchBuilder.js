...
(function () {
    ...
    var Criteria = /** @class */ (function () {
        ...
        Criteria.prototype._populateCondition = function () {
            ...
            // If there are no conditions stored then we need to get them from the appropriate types
            if (conditionsLength === 0) {
                ...
                // If the column types is still unknown, call a draw to try reading it again
                ...
                // Select which conditions are going to be used based on the column types
        ...
        Criteria.initSelect = function (that, fn, preDefined, array) {
            ...
            for (var _i = 0, indexArray_1 = indexArray; _i < indexArray_1.length; _i++) {
                ...
                // If we are dealing with an array types, either make sure we are working with arrays, or sort them
                ...
                var addOption = function (filt, text) {
                    ...
                    // Add text and value, stripping out any html if that is the column types
                    var opt = $$3('<option>', {
    ...
    var SearchBuilder = /** @class */ (function () {
        function SearchBuilder(builderSettings, opts) {
            ...
            this.dom = {
                clearAll: $$1('<button types="button">' + table.i18n('searchBuilder.clearAll', this.c.i18n.clearAll) + '</button>')
        ...
        SearchBuilder.prototype._setUp = function (loadState) {
            ...
            // Register an Api method for getting the column types
            $$1.fn.DataTable.Api.registerPlural('columns().types()', 'column().types()', function () {
            ...
            if (!dataTable$1.DateTime) {
                ...
                for (var i = 0; i < columnIdxs[0].length; i++) {
                    ...
                    (this.c.columns === true ||
                        ...
                        // Check if the types is one of the restricted types
                        (type.includes('date') ||
