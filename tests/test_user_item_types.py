...
from database.database_functions import add_new_user_item_type, \
...
class TestApp(TestAppParent):
    ...
    def test_add_and_delete_user_item_type(self):
        ...
        status, msg, item_type_dict = add_new_user_item_type(name=new_item_type_name, user_id=self.users['simon'].id)
